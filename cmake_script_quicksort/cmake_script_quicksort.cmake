...
# arr: 数组
# pivot: 基准值
# left: 划分后子数列变量名（比基准值小的部分）
# right: 划分后子数列变量名（比基准值大的部分)
function(partition arr pivot left right)
    # 遍历数列
    foreach(x ${arr})
        # 根据当前值与基准值的比较结果，分别将当前值追加到不同的子序列中
        if(${x} LESS ${pivot})
            list(APPEND _left ${x})
        else()
...
# "cmake" "-P" "cmake_script_quicksort" "---"
